...
#import "PWOAlbumViewController.h"

#import "PWOAggregatedMediaItemList.h"
#import "PWOSongCell.h"

@interface PWOAlbumViewController () {
  NSArray *_songData;
}

@end

@implementation PWOAlbumViewController
...
- (id)initWithArtist:(NSString *)artist andAlbumTitle:(NSString *)album
{
  ...
  [self.tableView registerClass:[PWOSongCell class] forCellReuseIdentifier:@"Song"];

  PWOAggregatedMediaItemList *collection = [PWOAggregatedMediaItemList sharedCollection];
  _songData = [collection songsOnAlbum:_album];
  return self;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
  ...
  NSDictionary *cellData = [_songData objectAtIndex:[indexPath row]];
